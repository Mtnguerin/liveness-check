...
var JEELIZFACEFILTER = (function() {
    window.JEELIZFACEFILTERGEN = function() {
        function Kb(a) {
            ...
            ;
            "undefined" !== typeof a && (q = Object.assign({}, n, a),
            this.A())
        }
        function fb(a, c) {
            var d = c % 8;
        ...
        function Pb() {
            ...
            if (!J.Ab)
                if (J.zb)
                    J.element.needsUpdate && (J.D.ie(J.element.videoWidth, J.element.videoHeight),
            ...
            for (c = 0; c < a; ++c) {
                ...
                D.set("s64");
                var d = Ca[da.wd()];
                D.H("u45", 1 + Na.Gc * (Math.cos(d.ry) - 1));
                S.Ea && D.H("u44", d.rz);
                da.re("u43");
                var h = Oa.pf();
                d = yb.Ye(Z.u, d, h);
            ...
            for (var a = 0; a < da.sa(); ++a)
                if (da.Jf(a)) {
                    ...
                    if (d.kb < ba.multiDetectionThresholdFactors[0] * ba.threshold)
                        ...
                        d.ya = Fa(1, q, 2, -n[2], n[2]);
                        for (n = 0; n < V.ba; ++n)
                            d.rd[n] = V.Da[n](Fa(2, q, n, 0, 1));
                        q = d.ca * V.ee;
                        h.dx = d.x - k.xRaw;
                        h.dy = d.y - k.yRaw;
                        h.ec = q - k.sRaw;
                        h.bc = d.rx - k.rx;
                        h.cc = d.ry - k.ry;
                        h.dc = S.Ea ? d.ya : d.ya - k.rz;
                        n = qa.ff();
                        h = (1 - $a.Fb(sa.translationFactorRange[0], sa.translationFactorRange[1], Math.sqrt(h.dx * h.dx + h.dy * h.dy + h.ec * h.ec) / n)) * (1 - $a.Fb(sa.rotationFactorRange[0], sa.rotationFactorRange[1], Math.sqrt(h.bc * h.bc + h.cc * h.cc + h.dc * h.dc) / n)) * $a.Fb(sa.qualityFactorRange[0], sa.qualityFactorRange[1], d.kb);
                        c = p[++kb[c] % p.length] = h;
                        for (n = 0; n < p.length; ++n)
                            c = Math.min(c, p[n]);
                        c = Math.max(.5, c);
                        h = Math.min(c, h);
                        p = wa.aa(sa.alphaRange[1], sa.alphaRange[0], Math.pow(h, ea.ze));
                        k.xRaw = wa.aa(k.xRaw, d.x, p);
                        k.yRaw = wa.aa(k.yRaw, d.y, p);
                        k.sRaw = wa.aa(k.sRaw, q, p);
                        k.rx = wa.aa(k.rx, d.rx, p);
                        k.ry = wa.aa(k.ry, d.ry, p);
                        k.rz = S.Ea ? k.rz + sa.followZRotAlphaFactor * p * d.ya : wa.aa(k.rz, d.ya, p);
        ...
        function Tb(a) {
            if (S.Na)
                Ab("string" === typeof S.Na ? JSON.parse(S.Na) : S.Na, a);
            else {
                var c = S.Xc;
        ...
        function Cb() {
            ...
            if (!a.w || !a.Ga || 4 > a.w || 4 > a.Ga)
                throw Error("INVALID VIDEO DIMENSIONS - width = " + a.w + " height = " + a.Ga);
            return a
        }
        function nb() {
            var a = Cb()
        ...
        var wa = {
          ...
          , D = function() {
            ...
            function h(e, m) {
                m.o = m.o ? !0 : !1;
                if (!m.o) {
                    m.Aa = m.Aa || "precision lowp float;attribute vec2 a0;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=a0*.5+vec2(.5);}";
                    m.ib = m.ib || ["a0"];
                    m.Pa = m.Pa || [2];
                    ...
                    var H = d(m.precision);
                    m.xa = c(e, H + m.Aa, H + m.g);
                    m.C = {};
                    m.i.forEach(function(P) {
                        m.C[P] = e.getUniformLocation(m.xa, P)
                    });
                    m.attributes = {};
                    m.Qa = [];
                    m.ib.forEach(function(P) {
                        var fa = e.getAttribLocation(m.xa, P);
                        m.attributes[P] = fa;
                        m.Qa.push(fa)
                    });
                    if (m.j) {
              ...
              , N = {
                ...
                xf: function(e, m, H) {
                    ...
                    O[e].Nb && O[e].Nb.forEach(function(M, P) {
                        v[m].g = v[m].g.replace(new RegExp(M,"g"), H[P])
                    });
                    h(b, v[m], m)
                },
                set: function(e) {
                ...
                Ze: function(e) {
                    return "undefined" === typeof v[e] ? !1 : v[e].ua
                },
                R: function() {
                    -1 !== l && (l = -1,
          ...
          , Ha = function() {
            ...
            var p = null
              ...
              , x = {
                ...
                ph: function(r) {
                    !q && r && (q = document.createElement("canvas"),
                    n = q.getContext("2d"));
                ...
                A: function(r) {
                    ...
                    r.la ? (b = r.la,
                    p = r.la.canvas) : r.fd && !r.jb ? p = document.getElementById(r.fd) : r.jb && (p = r.jb);
                    p || (p = document.createElement("canvas"));
                    p.width = r.width;
                    p.height = r.height;
                    if (b)
                        l = b instanceof WebGL2RenderingContext;
                    else {
                        l = !0;
                        var F = {
                        ...
                        var C = h(F);
                        C || !F.antialias || c() || (F.antialias = !1,
                        C = h(F));
                        C && (b = p.getContext("webgl2", F));
                        b ? l = !0 : ((b = p.getContext("webgl", F)) || (b = p.getContext("experimental-webgl", F)),
                        l = !1)
                    }
                    if (!b)
                        return a("WebGL1 and 2 are not enabled");
                    r.zc && p.addEventListener && (w = r.zc,
                    p.addEventListener("webglcontextlost", w, !1));
                    if (!Y.A())
                ...
                m: function() {
                    ...
                    D.m(),
                    Aa.m());
                    w && (p.removeEventListener("webglcontextlost", w, !1),
                    w = null);
                    b = t = n = q = p = null;
                    y.splice(0)
                }
          ...
          , za = function() {
            ...
            function c(e) {
                ...
                var m = e >> 16 & 32768
                  , H = e >> 12 & 2047
                  , M = e >> 23 & 255;
                return 103 > M ? m : 142 < M ? m | 31744 | ((255 == M ? 0 : 1) && e & 8388607) : 113 > M ? (H |= 2048,
                m | (H >> 114 - M) + (H >> 113 - M & 1)) : m = (m | M - 112 << 10 | H >> 1) + (H & 1)
            }
            function d(e) {
            ...
            var q = 0
              ...
              , N = {
                ...
                Vb: function(e) {
                    e !== q && (b.activeTexture(n[e]),
                    q = e)
                },
                instance: function(e) {
                    var m;
                    function H() {
                        T = void 0 !== B.I.videoWidth ? B.I.videoWidth : B.I.width;
                        U = void 0 !== B.I.videoHeight ? B.I.videoHeight : B.I.height
                    }
                    function M(G) {
                        var R = b.getError();
                        if ("FUCKING_BIG_ERROR" === R)
                            return !1;
                        b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, G);
                        R = b.getError();
                        R !== b.NO_ERROR && ha !== b.RGBA && (ha = b.RGBA,
                        b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, G));
                        return !0
                    }
                    function P() {
                        if (!Eb) {
                            ...
                            var G = B.isMipmap && !Qa;
                            b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, B.Jd ? b.LINEAR_MIPMAP_LINEAR : B.isLinear ? G ? b.NEAREST_MIPMAP_LINEAR : b.LINEAR : G ? b.NEAREST_MIPMAP_NEAREST : b.NEAREST);
                            ha = r[B.Gb - 1];
                            ka = F[B.Gb - 1];
                            ia = x[pb];
                            Y.na() && (G = Y.gf(),
                            ha === b.RGBA && ia === b.FLOAT ? B.isMipmap || B.isLinear ? ka = Aa.jf(b) : Y.bd() ? G && (ka = G) : ka = b.RGBA16F || b.RGBA : ha === b.RGB && ia === b.FLOAT && G && (ka = G,
                            ha = b.RGBA));
                            if (B.S && !B.isFloat || B.isFloat && B.isMipmap && Aa.Hf())
                                ka = Y.hf(),
                                ia = Y.ic(b);
                            B.tc && (cb = B.tc);
                            ...
                            if (B.I)
                                ...
                                G = ua;
                                try {
                                    "FUCKING_BIG_ERROR" !== b.getError() && (b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, G),
                                    b.getError() !== b.NO_ERROR && (b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null),
                                ...
                                G = b.getError(),
                                "FUCKING_BIG_ERROR" !== G && (b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null),
                                G = b.getError(),
                                G !== b.NO_ERROR && (ha = b.RGBA,
                                B.S && ia !== b.FLOAT && (ia = b.FLOAT,
                                b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, null))));
                            if (B.isMipmap)
                                if (!Qa && ca)
                                    ca.sb(),
                    ...
                    B.data && (B.array = "string" === typeof B.data ? Nb(B.data) : B.isFloat ? new Float32Array(B.data) : new Uint8Array(B.data),
                    B.isFlipY = !1);
                    var pb = 0
                      , Gb = B.I ? !0 : !1
                      , Ya = null
                    ...
                    var ca = {
                        ...
                        refresh: function() {
                            ...
                            Gb ? b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, B.I) : b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, ua);
                            Ba && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1)
                        },
                        ae: function() {
                            Wa || ta();
                        ...
                        Sb: function(G) {
                            ...
                            a(ra);
                            Ba && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !0);
                            R ? (Hb || (Ya = document.createElement("canvas"),
                            Ya.width = T,
                            Ya.height = U,
                            rb = Ya.getContext("2d"),
                            ...
                            b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, Ya)) : b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, G);
                            t[q] = Xa;
                            Ba && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1)
                        },
                        ui: function(G, R) {
                            ...
                            Wa || ("RGBA" === G || "RGBE" === G || "RGBAARRAY" === G ? (Ea = new Uint8Array(W),
                            Wa = !0) : "JSON" !== G || R || ta());
                            oa.M();
                            D.set(La);
                            ca.h(0);
                            ...
                            if ("RGBA" === G || "RGBE" === G || "RGBAARRAY" === G) {
                                ...
                                K || (A = document.createElement("canvas"),
                                z = A.getContext("2d"),
                                K = !0);
                                A.width = T;
                                A.height = U;
                    ...
                    if (B.url)
                        ...
                        B.array ? (B.S && !B.isFloat ? B.array instanceof Uint16Array ? (ua = B.array,
                        P()) : h() ? (ua = d(B.array),
                        P()) : (P(),
                        N.td(b, ra, ca.K(), ca.W(), B.array, Ba, !0)) : (ua = B.isFloat ? B.array instanceof Float32Array ? B.array : new Float32Array(B.array) : B.array instanceof Uint8Array ? B.array : new Uint8Array(B.array),
                        P()),
                        B.isKeepArray || (ua && ua !== B.array && (ua = null),
                        delete B.array)) : B.lc ? Ua = !0 : P();
                    ca.Ch = ca.K;
                    B.F && Ua && (B.F(ca),
                    B.F = null);
                    f.push(ca);
              ...
              , n = {
                ...
                instance: function(l) {
                    ...
                    if (l.indices) {
                        ...
                        var f = null;
                        65536 > l.indices.length ? (f = Uint16Array,
                        F = b.UNSIGNED_SHORT,
                        C = 2) : (f = Uint32Array,
                        F = b.UNSIGNED_INT,
                        C = 4);
                    ...
                    var E = {
                        Ee: function(K) {
                            p !== t && (b.bindBuffer(b.ARRAY_BUFFER, x),
                            p = t);
                            K && xa.Lc()
                        },
                        Be: function() {
                            q !== t && (b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, r),
                            q = t)
                        },
                        bind: function(K) {
                            E.Ee(K);
                ...
                Ca: function() {
                    -1 !== p && (b.bindBuffer(b.ARRAY_BUFFER, c.da),
                    p = -1);
                    -1 !== q && (b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, c.indices),
                    q = -1)
                },
                l: function(l, t) {
                    l && ma.Ca();
              ...
              , q = {
                ...
                instance: function(n) {
                    ...
                    var f = {
                        ...
                        rtt: function(E) {
                            l = E;
                            p.J !== C && (b.bindFramebuffer(b.FRAMEBUFFER, y),
                            p.J = C);
                            E.v()
                        },
                        M: function() {
                        ...
                        resize: function(E, K) {
                            t = E;
                            w = K;
                            x && (b.bindRenderbuffer(b.RENDERBUFFER, x),
                            b.renderbufferStorage(b.RENDERBUFFER, b.DEPTH_COMPONENT16, t, w))
                        },
                        remove: function() {
                            y === a || F || (b.bindFramebuffer(c, y),
            ...
            function h(g) {
                if (0 === f.ta.length) {
                    ...
                    for (var u = 0; u < f.Ta; ++u)
                        f.ta.push(b.createBuffer()),
                        f.ub.push(-1);
                    f.ja = 0;
                    f.xc = 0
                }
                b.bindBuffer(f.X, f.ta[f.ja]);
                g.byteLength !== f.ub[f.ja] && (b.bufferData(f.X, g.byteLength, b.STREAM_READ),
              ...
              , z = {
                A: function() {
                    ...
                    if (!w.Hd) {
                        w.Pc = z.ob(g);
                        w.Pc && (w.Ld = !0,
                        A.GL_EXT_HALFFLOAT = w.Pc);
                        if (w.Ld || z.na())
                            w.Qc = z.qd(g),
                            A.GL_EXT_HALFFLOATLINEAR = w.Qc;
                        w.Jh = w.Qc ? !0 : !1;
                        w.Hd = !0
                    }
                    w.Xb = z.md(g);
                ...
                $b: function(g) {
                    ...
                    g.clearColor(0, 0, 0, 0);
                    g.clear(g.COLOR_BUFFER_BIT);
                    g.RGBA32F && z.Pb(g, g.RGBA32F, g.FLOAT) && (u.ka = !0,
                    C = g.RGBA32F);
                    !u.ka && z.Pb(g, g.RGBA, g.FLOAT) && (u.ka = !0,
                    C = g.RGBA);
                    var I = z.ic(g);
                    F = null;
                    g.RGBA16F && z.Pb(g, g.RGBA16F, I) && (u.ma = !0,
                    F = g.RGBA16F);
                ...
                Re: function() {
                    ...
                    u.v();
                    z.flush();
                    b.checkFramebufferStatus(oa.kf()) !== b.FRAMEBUFFER_COMPLETE ? (za.cg(),
                    x.hc = !1) : x.hc = !0;
                    g.remove();
                    u.remove()
                },
          ...
          , Aa = function() {
            function a(g, u, I, L) {
                ...
                v = f.getError();
                v === f.INVALID_OPERATION && "undefined" !== typeof f.PIXEL_PACK_BUFFER && (f.bindBuffer(f.PIXEL_PACK_BUFFER, null),
                f.readPixels(0, 0, 2, 2, f.RGBA, f.UNSIGNED_BYTE, w),
                v = f.getError());
                if (v !== f.NO_ERROR)
                    return !1;
                I = !0;
                for (L = 0; 16 > L; ++L)
                    I = I && 4 > Math.abs(w[L] - 127);
                I && (l.Xd = u,
                l.Dd = g);
                return I
            }
            function c(g, u) {
                return E.ka && a(g, f.FLOAT, new Float32Array(y), u) ? (n = q.Yc,
                !0) : !1
            }
            function d(g, u, I) {
                if (!E.ma)
                ...
                var L = za.Ne(y)
                  , v = Y.ob(f);
                if (v && v.HALF_FLOAT_OES && a(g, v.HALF_FLOAT_OES, L, u) || f.HALF_FLOAT && a(g, f.HALF_FLOAT, L, u))
                    return n = q.Oa,
                    !0;
            ...
            return {
                instance: function(a) {
                    ...
                    var k = {
                      ...
                      , r = 1 / a.size;
                    a.Ef ? (a.sparsity = "undefined" !== typeof a.sparsity ? a.sparsity : a.Kb.kc(),
                    q = !1) : "full" === a.connectivityUp && (a.sparsity = a.Kb.kc());
                    var F = {
                        elu: "s19",
                        elu01: "s20",
                        relu: "s17",
                    ...
                    return {
                        ...
                        U: function(k) {
                            if (k.isEnabled) {
                                D.set("s28");
                                k.Lf.h(3);
                                for (var p = Math.min(k.ab.length, k.depth), q = 0; q < p; ++q)
                                    k.ab[q].Ce(4 + q)
                            } else
                                D.set(h);
                            D.H("u8", a.toLayerSize);
                            D.H("u9", a.fromLayerSize);
                            d.h(1);
                            Q.l(!1, !1)
                        }
                    }
          ...
          , dc = function() {
            return {
                instance: function(a) {
                    for (var c = a.fromLayerSize, d = a.toLayerSize, h = a.toSparsity, k = h * d, p = k / c, q = c / d, n = 0, l = 0, t = 0, w = Array(h * d * h * d * 4), y = Array(h * d * h * d * 4), x = Array(c * c), r = 0; r < x.length; ++r)
                        x[r] = 0;
                    r = Math.floor(h / 2);
          ...
          , ec = function() {
            return {
                instance: function(a, c) {
                    ...
                    D.Ze(w) || (a = Xb.cf(c, "gl_FragColor", "gl_FragColor"),
                    h = [{
                        type: "1f",
                        name: "u8",
                        value: h
                ...
                instance: function(a) {
                    ...
                    if (d.Za) {
                        var l = "uniform sampler2D u1;const float e=1.1111,g=2.2222;uniform vec2 u33;varying vec2 vv0;void main(){vec4 b=vec4(0.);float c=0.;for(float a=-e;a<=e;a+=1.){vec2 i=u33*a,j=vv0+i*g;float d=1.2*a/e,f=exp(-d*d);b+=f*texture2D(u1,j),c+=f;}gl_FragColor=b/c;}".replace("1.1111", Math.round((d.ga - 1) / 2).toFixed(2)).replace("2.2222", (1 / d.u).toFixed(6))
                          , t = "uniform sampler2D u0,u38;const float f=1.1111;const vec4 g=vec4(1.);const float h=2.2222;varying vec2 vv0;void main(){vec4 a=texture2D(u0,vv0),c=texture2D(u38,vv0),d=a*a,b=c,i=max(g*f,abs(d-b*b)),j=sqrt(i);gl_FragColor=h*(a-b)/j;}".replace("1.1111", d.pa.toFixed(4)).replace("2.2222", d.gain.toFixed(4));
                        n.push({
                            id: "s60",
                            name: "_",
                            g: l,
          ...
          , X = {
            ...
            Pe: function(a) {
                ...
                if (a.video.width && a.video.height) {
                    if (a.video.width.ideal && a.video.height.ideal) {
                        ...
                        ++l) {
                            ...
                            var t = {}
                              , w = 0;
                            for (t.qa = void 0; w < q.length; t = {
                                qa: t.qa
                            },
                            ++w)
                                if (t.qa = q[w],
                                n.ra !== a.video.width.ideal || t.qa !== a.video.height.ideal) {
                                    var y = Math.max(n.ra, t.qa) / Math.min(n.ra, t.qa);
                                    y < 4 / 3 - .1 || y > 16 / 9 + .1 || d(function(x, r) {
                                        return function(F) {
                                            F.video.width.ideal = x.ra;
                                            F.video.height.ideal = r.qa;
                                            return F
                                        }
                                    }(n, t))
                                }
                ...
                a.video.width && a.video.height && (a.video.width.ideal && a.video.height.ideal && d(function(x) {
            ...
            te: function(a, c, d) {
                return null === a ? Promise.resolve() : new Promise(function(h, k) {
                    if (a.srcObject && a.srcObject.getVideoTracks) {
                        ...
                        1 !== p.length ? k("INVALID_TRACKNUMBER") : (p = p[0],
                        c ? X.get(a, h, k, d) : (p.stop(),
                        h()))
                    } else
                        k("BAD_IMPLEMENTATION")
                }
                )
            },
            yd: function(a, c, d, h) {
                ...
                return navigator.mediaDevices.getUserMedia(h).then(function(q) {
                    ...
                    "undefined" !== typeof a.srcObject ? a.srcObject = q : (a.src = window.URL.createObjectURL(q),
                    a.videoStream = q);
                    X.Sd(a);
            ...
            get: function(a, c, d, h) {
                if (!a)
                    return d && d("VIDEO_NOT_PROVIDED"),
                    !1;
                if (!X.ed())
                    return d && d("MEDIASTREAMAPI_NOT_FOUND"),
                    !1;
                X.Va(a, "autoplay");
                X.Va(a, "playsinline");
            ...
            var c = {
              ...
              , F = {
                ...
                Qb: function(C) {
                    ...
                    Math.abs(n - l) > 1 - h.Sf && (f = Math.min(Math.max(Math.round(n), 0), h.n - 1),
                    f !== l && (n = l = f,
                    k = (h.rb[1] - h.rb[0]) / 2)),
                    p = C)
                },
          ...
          , Ma = function() {
            ...
            function d(v) {
                ...
                C += v,
                p(),
                g.isEnabled && g.$a && A.$ && C - g.rc > r.Wc && (t(),
                g.rc = C),
                F(C))
            }
            function h(v) {
            ...
            function p() {
                z.hb && (window.cancelAnimationFrame(z.hb),
                z.hb = null);
                z.timeout && (window.clearTimeout(z.timeout),
                z.timeout = null)
            }
            function q(v) {
                v && !A.$ ? (A.$ = !0,
            ...
            function t() {
                ...
                Y.flush();
                y().then(function(m) {
                    0 === m || isNaN(m) ? (g.isEnabled = !1,
                    console.log("WARNING in benchmark_GPUClock: WebGL timer queries is not working properly. timeElapsedNs =", m)) : (m = r.ve * r.Vc * 1E3 / m,
                    g.Ub = (g.Ub + 1) % r.Ma,
                    g.sc[g.Ub] = m,
                    ++g.Od > r.Ma && (g.Db.set(g.sc),
              ...
              , L = {
                A: function(v) {
                    ...
                    if (null !== r.Uc) {
                        ...
                        if (O = v.getExtension("EXT_disjoint_timer_query") || v.getExtension("EXT_disjoint_timer_query_webgl2")) {
                            ...
                            var N = l(v, v.VERTEX_SHADER, "attribute vec4 a0;void main(){gl_Position=a0;}")
                              , e = l(v, v.FRAGMENT_SHADER, "precision lowp float;uniform float u39;void main(){vec4 a=u39*vec4(1.,2.,3.,4.);for(int b=0;b<666;b+=1)a=cos(a);gl_FragColor=a;}".replace("666", r.Vc.toString()))
                              , m = v.createProgram();
                            v.attachShader(m, N);
                            v.attachShader(m, e);
                            v.linkProgram(m);
                    ...
                    if (r.Id) {
                        ...
                        v && ("onvisibilitychange"in document ? document.addEventListener("visibilitychange", n) : (window.addEventListener("blur", I),
                ...
                m: function() {
                    k();
                    A.oc && ("onvisibilitychange"in document ? document.removeEventListener("visibilitychange", n) : (window.removeEventListener("blur", I),
                    window.removeEventListener("focus", u)),
                    window.removeEventListener("pagehide", I),
                    window.removeEventListener("pageshow", u),
                    A.oc = !1);
                    A.pc ? (f.port.close(),
                    A.pc = !1) : A.qc && (f.Zd.terminate(),
                    A.qc = !1);
                    Object.assign(A, {
                        $: !0,
                        ua: !1,
          ...
          , da = function() {
            ...
            function k(f, E, K, A) {
                ...
                return f.some(function(u, I) {
                    if (!(u = I === K || z.va > u.va || 3 > u.va || !(0 < a(z.x, z.ca * r, u.x, u.ca * r)) || !(0 < a(z.y, z.ca * A * r, u.y, u.ca * A * r)))) {
                        u = F[I];
                        g.scale > u.scale ? I = g : (I = u,
                        u = g);
          ...
          , yb = function() {
            ...
            return {
                Ye: function(c, d, h) {
                    return d.isDetected ? Math.floor(d.s * c) : (c = Math.floor(Math.log2(c / 4)),
          ...
          , sb = {
            ...
            init: function(a) {
                ...
                for (d = 0; d < da.sa(); ++d)
                    jb.push(new Float32Array(ea.Qf)),
                    kb.push(0);
                Ma.A({
                ...
                sa = Object.create(ea.ng);
                a.stabilizationSettings && Object.assign(sa, a.stabilizationSettings);
                var h = 0;
                a.videoSettings && a.videoSettings.videoElement ? bb(a.videoSettings.videoElement, c) : (a.videoSettings && Object.assign(pa, a.videoSettings),
                ...
                Tb(function(k) {
                    ...
                    D.fb([{
                        id: "s63",
                        name: "_",
                        Aa: "attribute vec2 a0;uniform mat2 u40;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=vec2(.5)+u40*a0;}",
                        ib: ["a0"],
                        Pa: [2],
                        g: "uniform sampler2D u1;varying vec2 vv0;void main(){gl_FragColor=texture2D(u1,vv0);}",
                        i: ["u1", "u40"],
                    ...
                    zb();
                    V.buffer = new Uint8Array(8 * ea.oe * da.sa());
                    Sa = da.fc({
                        kb: 0,
                        x: 0,
                        y: 0,
            ...
            toggle_slow: function(a) {
                Za() && na === ja.play && (a && !S.Bb ? (S.Yd = S.ea,
                ba.nDetectsPerLoop = 1,
                this.set_animateDelay(ea.xg),
                S.Bb = !0) : !a && S.Bb && (ba.nDetectsPerLoop = -1,
